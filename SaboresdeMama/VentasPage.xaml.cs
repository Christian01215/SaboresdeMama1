...
public partial class VentasPage : ContentPage
{
    ...
    private async Task LoadVentasAsync()
    {
        ...
        // ===============================================
        // ===== LÓGICA PARA CALCULAR EL TOTAL DEL MES =====
        // ===============================================
        var now = DateTime.Now;

        // 3. Filtramos la lista para obtener solo las ventas de este mes Y este año
        ...
        nombreMes = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(nombreMes); // Pone la primera letra en mayúscula
